...
from job_search_mcp.domain.matching import bewerte_angebote
...
def run() -> None:
    ...
    for match in matches:
        ...
        print(
            f"{status:14} Score {match.score:3} | {match.angebot.firma} - {match.angebot.titel}"
        )
