...
class JobProfil:
    ...
    def __post_init__(self) -> None:
        ...
        object.__setattr__(self, "skills_pflicht", normalisiere_menge(*self.skills_pflicht))
        object.__setattr__(self, "skills_wunsch", normalisiere_menge(*self.skills_wunsch))
        object.__setattr__(self, "orte", normalisiere_tuple(*self.orte))
        object.__setattr__(self, "arbeitsmodelle", normalisiere_tuple(*self.arbeitsmodelle))
