...
def run(run_agent: bool = False) -> None:
    try:
        ...
        raise RuntimeError("Installieren mit: pip install -e '.[browser-use]'") from error
...
if __name__ == "__main__":
    ...
    parser.add_argument("--run", action="store_true", help="Agent mit Browser-Use-LLM starten")
