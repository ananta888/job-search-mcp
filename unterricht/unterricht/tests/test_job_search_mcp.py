...
from unterricht.browser_session import BrowserSessionFehler
from unterricht.job_search_mcp import (
...
class PortalToolsTest(_UmgebungsTest):
    ...
    def test_portal_login_ohne_daten_startet_interaktiv(self):
        ...
        _freigabe()
        try:
            with mock.patch("unterricht.job_search_mcp._manager") as manager_factory:
    ...
    def test_sichtbarer_login_ohne_display_liefert_klare_anweisung(self):
        ...
        try:
            with (
                ...
                mock.patch("unterricht.job_search_mcp._manager") as manager_factory,
    ...
    def test_portal_suche_ohne_sitzung_verwendet_oeffentlichen_pfad(self):
        ...
        try:
            with mock.patch(
                "unterricht.job_search_mcp._manager",
    ...
    def test_feed_suche_benoetigt_keinen_browser_manager(self):
        ...
        try:
            with (
                mock.patch("unterricht.job_search_mcp._manager") as manager_factory,
                mock.patch(
                    "unterricht.job_search_mcp.suche_feed", return_value=roh
                ) as feed_suche,
            ):
    ...
    def test_mehrportal_suche_isoliert_quellenfehler(self):
        ...
        with mock.patch(
            "unterricht.job_search_mcp.portal_suche", side_effect=fake_suche
        ):
...
class PortalSucheMitManagerTest(_UmgebungsTest):
    def test_mcp_browserwerkzeug_laeuft_in_worker_thread(self):
        ...
        try:
            with mock.patch("unterricht.job_search_mcp._manager", return_value=manager):
                asyncio.run(
                    mcp.call_tool(
                        "portal_suche",
                        {
    ...
    def test_portal_suche_liefert_angebote(self):
        ...
        try:
            with mock.patch(
                "unterricht.job_search_mcp._manager", return_value=FakeManager([])
            ):
    ...
    def test_portal_suche_verwendet_ersten_suchbegriff_des_profils(self):
        ...
        try:
            with mock.patch(
                ...
                ergebnis = portal_suche(
                    "stepstone", profil_pfad="profiles/job-suchprofil.json"
                )
