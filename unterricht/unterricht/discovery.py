...
from unterricht.models import CapturedHttpRequest, DiscoveryResult
from unterricht.profile import TeachingProfile
...
def discover_search(
    ...
    with sync_playwright() as playwright:
        ...
        try:
            ...
            if not isinstance(response_json, dict) or not isinstance(request_json, dict):
                raise TypeError("Die Unterrichts-API muss JSON-Objekte senden und empfangen")
